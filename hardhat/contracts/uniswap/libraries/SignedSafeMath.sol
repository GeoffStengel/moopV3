...
library SignedSafeMath {
    ...
    function div(int256 a, int256 b) internal pure returns (int256) {
        return div(a, b, "SignedSafeMath: division by zero");
    }

    /**
     * @dev Returns the integer division of two signed integers. Reverts with custom message on
     * division by zero. The result is rounded towards zero.
     *
     * Counterpart to Solidity's `/` operator. Note: this function uses a
     * `revert` opcode (which leaves remaining gas untouched) while Solidity
    ...
    function sub(int256 a, int256 b) internal pure returns (int256) {
        return sub(a, b, "SignedSafeMath: subtraction overflow");
    }

    /**
     * @dev Returns the subtraction of two signed integers, reverting with custom message on
     * overflow.
     *
     * Counterpart to Solidity's `-` operator.
     *
